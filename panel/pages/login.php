...
<div class="group">
    <div class="left">
     <img src="images/bsmart2.png" alt="" />    
    </div>

<div id="kepala" style="margin-top:0px; color:#86898e; background-color:#e8edf0;"><br />
<h2></h2><h3 style='margin-top:-5px'>SMP NURUL HUDA | JL. Kolonel Sugiono 103 Gg 3b Malang</h3><br />
    
    </div>     
    <div class="right">
	    <div>
        <h1>CBT SMP NURUL HUDA Login</h1>
        <p style="color:#8b8a8a">Selamat datang di aplikasi CBT SMP NURUL HUDA.
