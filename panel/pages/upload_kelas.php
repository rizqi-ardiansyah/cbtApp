...
<div style="width: 80%; float:right">
   Silahkan Klik logo Excel disamping, untuk <a href="../../file-excel/bee_kelas_temp.xls" target="_blank"> download </a> file excel database Kelas. 
   ...
   database melalui tool dibawah ini. 
       ...
       <a href="../../file-excel/bee_kelas_temp.xls" target="_blank"><button class="btn btn-success btn-lg btn-small" id="baru" value="Buat" name="baru"><i class="fa fa-file-excel-o"></i>
                            Download</button></a>
        
        <a href="?modul=daftar_kelas"><button class="btn btn-success btn-lg btn-small" id="baru" value="Buat" name="baru"><i class="fa fa-search"></i>
                            Lihat Data</button></a>
                        </div>
                    </div>
                    <!-- /.col-lg-4 -->
...
// $xlevel = str_replace("'","\'",$xlevel);
 ...
 if(!$x1==""){
		  ...
		  $query = "INSERT INTO cbt_kelas ( XKodeKelas, XKodeLevel, XNamaKelas, XKodeJurusan, XStatusKelas) VALUES ('$x1','$x2', '$x3', '$x4','1')";
