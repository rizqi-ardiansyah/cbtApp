...
?>
    ...
    <title>CBT SMP NURUL HUDA </title>
...
<header>
       ...
       <table width="100%" border="1"><tr><td bgcolor="0ED8BD"> <img src="../../images/<?php echo "$skul_ban"; ?>" style="margin-top:0px; height:100px; overflow:hidden">
        ...
        <div class="modal-content">
            <div class="panel-default">
                <div class="panel-heading">
                    ...
                    CBT SMP NURUL HUDA <a href="http://SMAN1-MLG.SCH.ID" target="_blank"> </a>| Find us on Facebook <a href=""><img src="images/fb.png"> </a> </h1>
                </div>
                <div class="panel-body">
                    <div class="inner-content">
                        <div class="wysiwyg-content">
                            ...
                            to Watch CBT SMP NURUL HUDA on <a href="" target="_blank">
...
<div id="headtop"  style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb; border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center">SMAN1-MLG.SCH.ID</div>
